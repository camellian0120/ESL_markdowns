...
---
### K平均法の例
左から、**初期中心**(1週目の2まで)、**初期分割**(1週目の3まで)、2週実行後、**20週実行後**の際のk平均法によるクラスタリングの様子を示す。

<img src="./ESLII_fig14-6_edited.png">
...
---
### ベクトル量子化の例
左側の元画像をベクトル量子化した結果を**中央(K=200)** と**右側(K=4)** に示す。
+ 中央は、多少の画質の劣化で**容量は0.24倍**程度に収まっている
+ 右側は、かなりの画質の劣化があるが**容量は0.0625倍**まで抑えられている

<img src="./ESLII_fig14-9.png">
...
---
### Kメドイド法の例
右の図は、左の表である**政治科学調査により得られた各国の非類似度**を元にKメドイド法によりクラスタリングしたものである。($k = 3$)
距離のみが与えられているため、K平均法は使えない。

<img src="./ESLII_fig14-10.png">
...
### 階層的クラスタリングの例
<div class="images">
<img src="./ESLII_fig14-12.png" height="600">
</div>
左図は、ヒト腫瘍マイクロアレイデータに、<strong>群平均凝集型階層的クラスタリング</strong>を適用して得られた<strong>デンドログラム</strong>である。
...
---
前述の**凝縮型クラスタリング**の違いは以下の通り。左から**群平均**、**完全連結**、**単連結**の凝縮型階層的クラスタリングで得られたデンドログラムである。

<img src="./ESLII_fig14-13.png" height=450>
...
### 自己組織化マップの例
<div class="images">
  <img src="./ESLII_fig14-17.png" height=600>
</div>
左図は、<strong>SOM</strong>による当てはめ結果である<br/>
3次元データを<strong>2次元表示</strong>できている。<br/>
重なっている線は、赤点が<strong>対角の位置にプロット</strong>されており、2次元平面上で距離の関係を保つために、<strong>曲面が対角線上に折りたたまれて</strong>繋がっているから。
